...
/// </summary>
public static class TelegramFrameCodec
{
    ...
    public static string Decode(string raw)
    {
        ...
        {
            throw new TelegramFormatException("La trama no inicia con el delimitador <LF> esperado.");
        }

        if (raw[^1] != EndDelimiter)
        {
            throw new TelegramFormatException("La trama no termina con el delimitador <CR> esperado.");
        }
